  ...
  <div>
    <div className="Hero">
      <div className="HeroGroup">
        ...
        <p>Complate courses about the best tools and design system. Prototype and build apps with React and Swift.</p>
    ...
    <div className="Cards">
      ...
      <div className="CardGroup">
        ...
        <Card title="Sound Desgin" text="5 sections" image={require('../images/wallpaper3.jpg')} />
    ...
    <Section 
      ...
      text="Learn how to builda modern site using
      ...
      dynamic data with Contenful and deploying your
      site with Netlify."
    />
  </div>
)
